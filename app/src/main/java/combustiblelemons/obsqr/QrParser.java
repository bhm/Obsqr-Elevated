...
import combustiblelemons.obsqr.wifi.WiFi;
...
public class QrParser {
    ...
    private static class QrContentWiFi extends BaseQrContent {
        ...
        public QrContentWiFi(Context mContext, String raw) {
            mRaw = raw;
            context = mContext;
        ...
        private void parse(String raw) {
            /*
			 * WIFI:S:$SSID;T:$mEncryption;P:$PASSWORD;H:$HIDDEN;
			 */
            mWiFi = WiFi.from(raw);
        }
    ...
    private static class QrContentvCard extends BaseQrContent {
        ...
        private void parse() {
            ...
            mName = card.Name;
            mAddress = card.first(card.mAddresses);
            mPhone = card.first(card.mPhones);
            mEmail = card.first(card.mEmails);
