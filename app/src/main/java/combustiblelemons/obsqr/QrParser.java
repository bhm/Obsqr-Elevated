...
public class QrParser {
    ...
    private static class QrContentWiFi extends BaseQrContent {
            ...
            for (String row : rows) {
                if (row.split(":").length > 1) {
                    ...
                    if (property.equalsIgnoreCase("S")) {
                        ...
                        ENCRYPTION = value;
                        if (WifiEncryption.NO_PASS.matches(ENCRYPTION)) {
                            PASS = "";
                        }
                    }
                }
        ...
        public void launch() throws ActivityNotFoundException {
            manager = new WiFi(context);
            manager.enable(SSID, PASS, ENCRYPTION, hidden);
        ...
        public String toString() {
            ...
            if (WifiEncryption.NO_PASS.matches(ENCRYPTION) && PASS.length() == 0) {
